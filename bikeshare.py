...
def get_filters():
    ...
    """
    print('Hello! Let\'s explore some US bikeshare data! Please enjoy all outputs provided!')
    # TO DO: get user input for city (chicago, new york city, washington). HINT: Use a while loop to handle invalid inputs

    while True:
      city = input('Please select one of the following cities; chicago, new york city, or washington:').lower()
      if city not in CITY_DATA:
        print('Please select again from city list.')
      else:
        break
    ...
    while True:
      day = input("Please enter a day of the week or 'all' to select all days.").lower()
